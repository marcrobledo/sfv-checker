...
function md5(u8array){
	var n=u8array.length,state=[1732584193,-271733879,-1732584194,271733878],i;
	for(i=64;i<=u8array.length;i+=64)
	...
	var hexString=state.join('').toString(16);
